...
class ClasicaActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        add_icon.setOnClickListener {
            Toast.makeText(
                this,
                "Pedido agregado satisfactoriamente a la cuenta".toString(), Toast.LENGTH_SHORT).show()
            ...
            shoppingButton.setOnClickListener {
                ...
                view.alertButton.setOnClickListener {
                    ...
                    val intent = Intent(this, ClasicaPagoActivity::class.java)
